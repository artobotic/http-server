...
var fs = require('fs'),
    ...
    findSkillsModule = require('./find-skills');
...
function HttpServer(options) {
  ...
  if (options.skillsApi !== false) {
    var skillsBankPath = options.skillsBankPath || undefined;
    before.push(function (req, res) {
      ...
      var limit = Math.min(parseInt(parsed.query.limit, 10) || 5, 50);
      findSkillsModule.findSkills(query, { limit: limit, bankPath: skillsBankPath })
